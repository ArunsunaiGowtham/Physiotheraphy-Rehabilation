...
(function () {
  ...
  const ALL_ARTICLES = [
    ...
    },
    {
      ...
      authorId: 'vance',
      authorRole: 'Board-Certified Sports Clinical Specialist & Athletic Performance Director',
    ...
    },
    {
      ...
      authorId: 'patel',
      authorRole: 'Certified Ergonomic Assessment Specialist & Spinal Biomechanics Lead',
    ...
    // --- Pain Relief Category Posts ---
    {
      ...
      authorId: 'reed',
      authorRole: 'Musculoskeletal Ultrasound & Joint Degeneration Lead',
    ...
    },
    {
      ...
      author: 'Dr. Chloe Bennett',
      authorId: 'bennett',
      authorRole: 'Chronic Pain Neurobiology & Central Sensitization Specialist',
    ...
    },
    {
      ...
      author: 'Dr. Liam Gallagher',
      authorId: 'gallagher',
      authorRole: 'Myofascial Release & Dynamic Mobility Lead',
    ...
    // --- Sports Injuries Category Posts ---
    {
      ...
      authorId: 'sterling',
      authorRole: 'Tendon Reconstruction & Orthopedic Surgical Fellow',
      authorImg: 'assets/images/therapist-sterling.jpg',
      date: 'Aug 30, 2026',
      readingTime: '7 min read',
    ...
    },
    {
      ...
      author: 'Dr. Nathan Cross',
      authorId: 'cross',
      authorRole: '3D Running Kinematics & Endurance Biomechanics Specialist',
    ...
    },
    {
      ...
      author: 'Dr. Tyler Brooks',
      authorId: 'brooks',
      authorRole: 'Vestibular-Ocular Rehab & Concussion Protocol Specialist',
      authorImg: 'assets/images/therapist-brooks.jpg',
      date: 'Aug 14, 2026',
      readingTime: '7 min read',
    ...
    // --- Ergonomics Category Posts ---
    {
      ...
      authorId: 'chen',
      authorRole: 'Certified Manual Physical Therapist & Joint Arthroplasty Lead',
    ...
    },
    {
      ...
      author: 'Dr. Hannah Al-Mansoor',
      authorId: 'almansoor',
      authorRole: 'Adaptive Living & Workplace Ergonomics Director',
      authorImg: 'assets/images/therapist-almansoor.jpg',
      date: 'Aug 16, 2026',
      readingTime: '5 min read',
...
// --- 10 Additional Clinical Guides (Total = 27) ---
    ...
    },
    {
      ...
      authorId: 'hayes',
      authorRole: 'Board-Certified Geriatric & Post-Surgical Arthroplasty Specialist',
      authorImg: 'assets/images/therapist-hayes.jpg',
      date: 'Aug 25, 2026',
      readingTime: '7 min read',
    ...
    },
    {
      ...
      authorId: 'laurent',
      authorRole: 'Vestibular Oculomotor & Balance Retraining Specialist',
      authorImg: 'assets/images/therapist-laurent.jpg',
      date: 'Jul 10, 2026',
      readingTime: '6 min read',
    ...
    },
    {
      ...
      authorId: 'rostova',
      authorRole: 'Board-Certified Neurological Specialist & Vestibular Director',
    ...
    },
    {
      ...
      author: 'Dr. Alexei Voronov',
      authorId: 'voronov',
      authorRole: 'Stroke Recovery & Certified Brain Injury Specialist',
      authorImg: 'assets/images/therapist-voronov.jpg',
      date: 'Aug 02, 2026',
      readingTime: '6 min read',
    ...
    },
    {
      ...
      authorId: 'watson',
      authorRole: 'Joint Mobilization & Functional Movement Specialist',
      authorImg: 'assets/images/therapist-watson.jpg',
      date: 'Jun 22, 2026',
      readingTime: '6 min read',
  ...
  function getAuthorTherapistId(authorOrArticle) {
    ...
    if (name.includes('bennett') || name.includes('chloe')) return 'bennett';
    if (name.includes('reed') || name.includes('julian')) return 'reed';
    if (name.includes('gallagher') || name.includes('liam')) return 'gallagher';
    if (name.includes('hayes') || name.includes('robert')) return 'hayes';
    if (name.includes('mansoor') || name.includes('hannah')) return 'almansoor';
    if (name.includes('watson') || name.includes('emily')) return 'watson';
    if (name.includes('brooks') || name.includes('tyler')) return 'brooks';
    if (name.includes('voronov') || name.includes('alexei')) return 'voronov';
    if (name.includes('laurent') || name.includes('sophie')) return 'laurent';
    if (name.includes('sterling') || name.includes('james')) return 'sterling';
    if (name.includes('cross') || name.includes('nathan')) return 'cross';
    if (name.includes('patel') || name.includes('maya')) return 'patel';
    return 'jenkins';
  }
