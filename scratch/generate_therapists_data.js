...
const THERAPISTS = {
  jenkins: {
    ...
    hours: { monWed: '7:30 AM – 3:30 PM', thuFri: '11:00 AM – 7:00 PM', sat: 'By Appointment Only' },
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'Columbia University', desc: 'Doctor of Physical Therapy (DPT), Magna Cum Laude' },
      { icon: 'fas fa-certificate', color: 'text-secondary', title: 'American Board of Physical Therapy', desc: 'Board-Certified Orthopedic Clinical Specialist (OCS)' },
      { icon: 'fas fa-check-circle', color: 'text-success', title: 'The McKenzie Institute USA', desc: 'Certified in Mechanical Diagnosis and Therapy (Cert. MDT)' },
      { icon: 'fas fa-syringe', color: 'text-info', title: 'Integrative Dry Needling Institute', desc: 'Certified Myofascial Trigger Point Dry Needling (CIDN)' }
    ],
  ...
  vance: {
    ...
    languages: 'English',
    hours: { monWed: '8:00 AM – 4:00 PM', thuFri: '10:00 AM – 6:00 PM', sat: 'By Appointment Only' },
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'University of Southern California', desc: 'Doctor of Physical Therapy (DPT), Sports Specialization' },
      { icon: 'fas fa-award', color: 'text-secondary', title: 'American Board of Physical Therapy', desc: 'Board-Certified Sports Clinical Specialist (SCS)' },
      { icon: 'fas fa-running', color: 'text-success', title: 'Titleist Performance Institute', desc: 'TPI Certified Rotational & Overhead Biomechanics' },
      { icon: 'fas fa-stopwatch-20', color: 'text-info', title: 'Owens Recovery Science', desc: 'Certified Blood Flow Restriction (BFR) Practitioner' }
    ],
  ...
  chen: {
    ...
    hours: { monWed: '8:00 AM – 4:00 PM', thuFri: '11:00 AM – 7:00 PM', sat: 'By Appointment Only' },
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'New York University', desc: 'Doctor of Physical Therapy (DPT), Orthopedic Focus' },
      { icon: 'fas fa-hands-helping', color: 'text-secondary', title: 'NAIOMT Manual Institute', desc: 'Certified Manipulative Physical Therapist (CMPT)' },
      { icon: 'fas fa-procedures', color: 'text-success', title: 'Hospital for Special Surgery', desc: 'Advanced Arthroplasty Post-Op Rehabilitation Fellow' },
      { icon: 'fas fa-tape', color: 'text-info', title: 'Kinesio Taping Association', desc: 'Certified Kinesio Taping Practitioner (CKTP) - Edema' }
    ],
  ...
  bennett: {
    ...
    hours: { monWed: '8:30 AM – 4:30 PM', thuFri: '10:00 AM – 6:00 PM', sat: 'By Appointment Only' },
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'Duke University School of Medicine', desc: 'Doctor of Physical Therapy (DPT), Pain Science Honors' },
      { icon: 'fas fa-brain', color: 'text-secondary', title: 'International Spine & Pain Institute', desc: 'Therapeutic Pain Specialist (TPS Certification)' },
      { icon: 'fas fa-heartbeat', color: 'text-success', title: 'Herman & Wallace Pelvic Rehab', desc: 'Pelvic Rehabilitation Practitioner Certified (PRPC)' },
      { icon: 'fas fa-bolt', color: 'text-info', title: 'American Physical Therapy Association', desc: 'Graded Motor Imagery & Neurodynamics Credential' }
    ],
  ...
  reed: {
    ...
    languages: 'English',
    hours: { monWed: '7:00 AM – 3:00 PM', thuFri: '9:00 AM – 5:00 PM', sat: 'By Appointment Only' },
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'Emory University School of Medicine', desc: 'Doctor of Physical Therapy (DPT), Joint Mechanics Track' },
      { icon: 'fas fa-wave-square', color: 'text-secondary', title: 'APCA Registry', desc: 'Registered in Musculoskeletal Sonography (RMSK)' },
      { icon: 'fas fa-bone', color: 'text-success', title: 'Maitland-Australian Physiotherapy Seminars', desc: 'Certified Orthopedic Manual Therapist (COMT)' },
      { icon: 'fas fa-compress-arrows-alt', color: 'text-info', title: 'Mulligan Concept Teachers Association', desc: 'Certified Mulligan Practitioner (CMP)' }
    ],
  ...
  gallagher: {
    ...
    languages: 'English',
    hours: { monWed: '9:00 AM – 5:00 PM', thuFri: '11:00 AM – 7:00 PM', sat: 'By Appointment Only' },
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'University of Pittsburgh', desc: 'Doctor of Physical Therapy (DPT), Movement Science' },
      { icon: 'fas fa-dumbbell', color: 'text-secondary', title: 'National Strength & Conditioning Association', desc: 'Certified Strength & Conditioning Specialist (CSCS)' },
      { icon: 'fas fa-tools', color: 'text-success', title: 'Graston Technique USA', desc: 'Certified Instrument-Assisted Soft Tissue Mobilization (GTS)' },
      { icon: 'fas fa-feather', color: 'text-info', title: 'Functional Movement Systems', desc: 'FMS Level 2 Certified Movement Specialist' }
    ],
  ...
  rostova: {
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'Northwestern University', desc: 'Doctor of Physical Therapy (DPT), Neuro-Rehab Honors' },
      { icon: 'fas fa-brain', color: 'text-secondary', title: 'American Board of Physical Therapy', desc: 'Board-Certified Neurological Clinical Specialist (NCS)' },
      { icon: 'fas fa-compass', color: 'text-success', title: 'Emory University School of Medicine', desc: 'Advanced Competency in Vestibular Rehabilitation (VRT)' },
      { icon: 'fas fa-walking', color: 'text-info', title: 'LSVT Global Organization', desc: 'Certified LSVT BIG Practitioner for Parkinson’s Disease' }
    ],
  ...
  hayes: {
    ...
    languages: 'English',
    hours: { monWed: '8:00 AM – 3:30 PM', thuFri: '9:30 AM – 5:00 PM', sat: 'By Appointment Only' },
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'Boston University Sargent College', desc: 'Doctor of Physical Therapy (DPT), Geriatric Specialization' },
      { icon: 'fas fa-award', color: 'text-secondary', title: 'American Board of Physical Therapy', desc: 'Board-Certified Geriatric Clinical Specialist (GCS)' },
      { icon: 'fas fa-shield-alt', color: 'text-success', title: 'Matter of Balance National Institute', desc: 'Master Certified Fall Prevention Trainer' },
      { icon: 'fas fa-bone', color: 'text-info', title: 'National Osteoporosis Foundation', desc: 'Bone-Fit Certified Osteoporosis Exercise Specialist' }
    ],
  ...
  almansoor: {
    ...
    hours: { monWed: '8:00 AM – 5:00 PM', thuFri: '8:00 AM – 5:00 PM', sat: 'Weekend Visits Available' },
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'University of Michigan', desc: 'Doctor of Physical Therapy (DPT), Acute Rehabilitation Honors' },
      { icon: 'fas fa-home', color: 'text-secondary', title: 'Home Health Section APTA', desc: 'Certified Home Health Physical Therapy Specialist' },
      { icon: 'fas fa-chair', color: 'text-success', title: 'Executive Certificate in Home Modification', desc: 'USC Leonard Davis School of Gerontology' },
      { icon: 'fas fa-heartbeat', color: 'text-info', title: 'American Heart Association', desc: 'Advanced Cardiovascular Life Support (ACLS) Certified' }
    ],
  ...
  watson: {
    ...
    languages: 'English',
    hours: { monWed: '8:30 AM – 4:00 PM', thuFri: '9:00 AM – 5:30 PM', sat: 'By Appointment Only' },
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'UNC Chapel Hill', desc: 'Doctor of Physical Therapy (DPT), Pediatric Fellowship' },
      { icon: 'fas fa-child', color: 'text-secondary', title: 'American Board of Physical Therapy', desc: 'Board-Certified Pediatric Clinical Specialist (PCS)' },
      { icon: 'fas fa-baby', color: 'text-success', title: 'Academy of Pediatric Physical Therapy', desc: 'Infant Torticollis & Plagiocephaly Specialist' },
      { icon: 'fas fa-puzzle-piece', color: 'text-info', title: 'Neuro-Developmental Treatment Association', desc: 'C/NDT Certified Pediatric Practitioner' }
    ],
  ...
  brooks: {
    ...
    languages: 'English',
    hours: { monWed: '7:30 AM – 3:30 PM', thuFri: '10:00 AM – 6:00 PM', sat: 'By Appointment Only' },
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'University of Florida', desc: 'Doctor of Physical Therapy (DPT), Exercise Physiology' },
      { icon: 'fas fa-water', color: 'text-secondary', title: 'Aquatic Therapy & Rehab Institute', desc: 'ATRI-C Certified Aquatic Therapist' },
      { icon: 'fas fa-swimmer', color: 'text-success', title: 'Bad Ragaz Ring Method Council', desc: 'Certified Aquatic Manual Therapist (BRRM)' },
      { icon: 'fas fa-life-ring', color: 'text-info', title: 'American Red Cross', desc: 'Lifeguard & Water Safety Instructor (WSI)' }
    ],
  ...
  voronov: {
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'University of Washington', desc: 'Doctor of Physical Therapy (DPT), Neuro-Trauma Honors' },
      { icon: 'fas fa-brain', color: 'text-secondary', title: 'Brain Injury Association of America', desc: 'Certified Brain Injury Specialist (CBIS)' },
      { icon: 'fas fa-walking', color: 'text-success', title: 'LiteGait Clinical Academy', desc: 'Certified Body-Weight Supported Treadmill Trainer' },
      { icon: 'fas fa-bolt', color: 'text-info', title: 'Bioness Neuromuscular Institute', desc: 'Functional Electrical Stimulation (FES) Practitioner' }
    ],
  ...
  laurent: {
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'Northwestern University', desc: 'Doctor of Physical Therapy (DPT), Vestibular Track' },
      { icon: 'fas fa-compass', color: 'text-secondary', title: 'Emory University School of Medicine', desc: 'Certificate of Vestibular Rehabilitation Competency (VRT)' },
      { icon: 'fas fa-eye', color: 'text-success', title: 'American Balance Institute', desc: 'Certified Video-Nystagmography Examiner' },
      { icon: 'fas fa-shield-virus', color: 'text-info', title: 'Vestibular Disorders Association (VeDA)', desc: 'Professional Clinical Affiliate Member' }
    ],
  ...
  sterling: {
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'University of Virginia', desc: 'Doctor of Physical Therapy (DPT), Orthopedic Fellow' },
      { icon: 'fas fa-award', color: 'text-secondary', title: 'AAOMPT Fellowship Academy', desc: 'Fellow of American Academy of Orthopaedic Manual PT (FAAOMPT)' },
      { icon: 'fas fa-band-aid', color: 'text-success', title: 'American Board of Physical Therapy', desc: 'Board-Certified Sports Clinical Specialist (SCS)' },
      { icon: 'fas fa-shield-alt', color: 'text-info', title: 'Orthopedic Trauma Association', desc: 'Complex Multi-Ligament Post-Surgical Specialist' }
    ],
  ...
  cross: {
    ...
    languages: 'English',
    hours: { monWed: '8:00 AM – 4:00 PM', thuFri: '10:30 AM – 6:30 PM', sat: 'Saturday Morning Gait Clinic' },
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'University of Colorado Boulder', desc: 'Doctor of Physical Therapy (DPT), Biomechanics Lab' },
      { icon: 'fas fa-running', color: 'text-secondary', title: 'National Strength & Conditioning Association', desc: 'Certified Strength & Conditioning Specialist (CSCS)' },
      { icon: 'fas fa-video', color: 'text-success', title: 'The Running Clinic International', desc: 'Certified Running Injury Specialist (Y-Balance)' },
      { icon: 'fas fa-shoe-prints', color: 'text-info', title: 'USATF Track & Field Level 2', desc: 'Certified Endurance Running Gait Coach' }
    ],
  ...
  patel: {
    ...
    hours: { monWed: '8:30 AM – 4:30 PM', thuFri: '9:30 AM – 5:30 PM', sat: 'By Appointment Only' },
    ...
    credentials: [
      { icon: 'fas fa-graduation-cap', color: 'text-primary', title: 'Georgetown University', desc: 'Doctor of Physical Therapy (DPT), Orthopedic Honors' },
      { icon: 'fas fa-laptop', color: 'text-secondary', title: 'The Ergonomics Center of North Carolina', desc: 'Certified Ergonomic Assessment Specialist (CEAS III)' },
      { icon: 'fas fa-align-center', color: 'text-success', title: 'Kendall Postural Assessment Academy', desc: 'Advanced Postural & Musculoskeletal Screening' },
      { icon: 'fas fa-chair', color: 'text-info', title: 'Ergonomics Institute of America', desc: 'Workplace Injury Prevention Consultant' }
    ],
...
console.log('Total therapists configured:', Object.keys(THERAPISTS).length);
fs.writeFileSync('scratch/therapists_dataset.json', JSON.stringify(THERAPISTS, null, 2));
console.log('Dataset written to scratch/therapists_dataset.json');
